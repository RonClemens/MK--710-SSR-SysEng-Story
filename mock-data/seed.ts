...
export const SEED_DATA: Database = {
  ...
  // Deprecated by PKM Migration Step 9 (per PKM Migration Plan v0.3.0 §8) —
  // superseded by the milestoneType: "AcquisitionGate" records added to
  // `milestones` above. Kept in place, unchanged, per the coexist-then-
  // deprecate window: see AcquisitionMilestone's own comment in
